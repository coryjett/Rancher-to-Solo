...
This will provision a second gateway attached to the new `1-22` Istio control plane exposed by a new service.  Cutting over to the new gateway will be done at the upstream loadbalancer (such as an LTM) in this scenario as detailed [here](https://istio.io/latest/docs/setup/additional-setup/gateway/#canary-upgrade-with-external-traffic-shifting-advanced).
